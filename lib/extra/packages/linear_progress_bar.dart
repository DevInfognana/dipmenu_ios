...
class _VerticalBarIndicatorState extends State<VerticalBarIndicator> {
  ...
  //                 curve: Curves.linear,
  //                 duration:
  //                     widget.animationDuration ?? const Duration(seconds: 2),
  //                 width: widget.width ?? 20,
  //                 height: widget.percent * widget.height!,
  //                 decoration: BoxDecoration(
      ...
      children: [
        Wrap(
            ...
            children: [
              widget.footer != null
                  ? Text(widget.footer!,
                  style: widget.footerStyle, textAlign: TextAlign.center)
                  : const SizedBox.shrink(),
            ]),
        ...
        const SizedBox(width: 5),
        widget.header != null
            ? Text(widget.header!, style: widget.headerStyle)
            : const SizedBox.shrink(),
