...
class RewardsDropdownMethod extends StatefulWidget {
  RewardsDropdownMethod(
      {Key? key, this.controller, required this.onViewbuttonpressed})
      : super(key: key);

  RewardsProductController? controller;
  void Function(dynamic) onViewbuttonpressed;

  @override
  State<RewardsDropdownMethod> createState() => _RewardsDropdownMethodState();
}

class _RewardsDropdownMethodState extends State<RewardsDropdownMethod> {
  @override
        ...
        child: DropdownButton2(
          ...
          items: widget.controller?.itemSize
              .map((item) => DropdownMenuItem<String>(
                    ...
                    //   widget.controller?.totalPrice = double.parse(itemPointsId(
