...
class MenuCategoryItem extends StatefulWidget {
  ...
  @override
  State<MenuCategoryItem> createState() => _MenuCategoryItemState();
}
                        ...
                        onTap: () {
                          if (widget.customizeMenuItems[index].isChecked ==
                            ...
                            if (widget.controller.isWeightCheck != '1' &&  widget.controller.hybridProduct != 1) {
                              ...
                              .customizeMenuItems[index].isChecked = true) {
                        ...
                        child: Stack(
                          children: [
                            PhysicalModel(
                                ...
                                elevation: widget.customizeMenuItems[index]
                                            .isChecked ==
                                        true
                                    ? 8
                                    : 2,
                                shadowColor: widget.customizeMenuItems[index]
                                            .isChecked ==
                                        true
                                ...
                                child: Card(
                                  color: widget.customizeMenuItems[index]
                                              .isChecked ==
                                          true
